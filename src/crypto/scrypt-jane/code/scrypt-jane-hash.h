...
#include <crypto/scrypt-jane/code/scrypt-jane-hash_blake512.h>
#elif defined(SCRYPT_BLAKE256)
#include <crypto/scrypt-jane/code/scrypt-jane-hash_blake256.h>
#elif defined(SCRYPT_SHA512)
#include <crypto/scrypt-jane/code/scrypt-jane-hash_sha512.h>
#elif defined(SCRYPT_SHA256)
#include <crypto/scrypt-jane/code/scrypt-jane-hash_sha256.h>
#elif defined(SCRYPT_SKEIN512)
#include <crypto/scrypt-jane/code/scrypt-jane-hash_skein512.h>
#elif defined(SCRYPT_KECCAK512) || defined(SCRYPT_KECCAK256)
#include <crypto/scrypt-jane/code/scrypt-jane-hash_keccak.h>
#else
...
#include <crypto/scrypt-jane/code/scrypt-jane-pbkdf2.h>
