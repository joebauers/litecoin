...
VERSION=
commit=false
url=https://github.com/joebauers/litecoin
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/joebauers/litecoin
...
then
    ...
    git clone https://github.com/joebauers/gitian.sigs.ltc.git
    git clone https://github.com/joebauers/litecoin-detached-sigs.git
